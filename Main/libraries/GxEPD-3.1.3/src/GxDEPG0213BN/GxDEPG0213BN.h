...
class GxDEPG0213BN : public GxEPD
{
  ...
  private:
    ...
    int8_t _rst;
    int8_t _busy;
    static const uint16_t power_on_time = 100; // ms, e.g. 91428us
    static const uint16_t power_off_time = 150; // ms, e.g. 142212us
    static const uint16_t full_refresh_time = 4000; // ms, e.g. 3661376us
    static const uint16_t partial_refresh_time = 800; // ms, e.g. 736344us
